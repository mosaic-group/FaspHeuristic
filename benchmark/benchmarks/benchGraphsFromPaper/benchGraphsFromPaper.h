 ...
 * benchmark benchGraphsFromPaper --outputDirectory . --inputDirectory ../benchmark/benchmarks/benchGraphsFromPaper/data/
 */

std::string getFilenameOfBenchGraphsFromPaper1() {
    return std::string("BenchGraphsFromPaper.h5");
}


void benchGraphsFromPaper1(const std::string &outputDir, const std::string &inputDir) {
    LOG(TRACE) << "Running benchGraphsFromPaper";
