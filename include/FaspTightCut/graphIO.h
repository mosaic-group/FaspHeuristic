...
namespace Graph::IO {
    /**
     * Reads data provided as adjacency list (fist number in a line is a benchmark vertex,
    ...
    /**
     * Save provided graph as adjacency list (fist number in a line is a benchmark vertex,
     * and next number(s) are outgoing veritces). Example file content.
     *
     * 1 4
     * 3 10
    ...
    static int solutionFromFile(const std::string &aFileName) {
        ...
        while (std::getline(infile, line)) {
            ...
            // Each correct line of solution file contain benchmark and destination vertex
